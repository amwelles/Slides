...
* "Images with captions":http://archive.slidesjs.com/examples/images-with-captions/
* "Linking":http://archive.slidesjs.com/examples/linking/
* "Product":http://archive.slidesjs.com/examples/product/
* "Multiple slideshows":http://archive.slidesjs.com/examples/multiple/
* "Simple (unstyled)":http://archive.slidesjs.com/examples/simple/
* "Standard":http://archive.slidesjs.com/examples/standard/
